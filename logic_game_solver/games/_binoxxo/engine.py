...
class BinoxxoEngine(BaseGameEngine):
    """
    Engine for solving the Binoxxo game.
    Inherits from BaseGameEngine and implements specific rules for Binoxxo.
    """
    @property
    def solver(self):
        """
        ...
        """
        return self.__class__.__name__  # 'BinoxxoEngine'
    
    def enforce(self, name: str, field: FieldState) -> FieldState:
        """
        Enforce the rules of the Binoxxo game on the given field state.
